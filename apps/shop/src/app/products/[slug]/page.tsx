    ...
    <section className="text-gray-700 body-font overflow-hidden bg-white">
      <div className="container px-5 py-5 md:py-24 mx-auto">
        <div className="lg:w-4/5 mx-auto flex flex-wrap">
          <DetailImage slides={Array.from(Array(10).keys())} options={{}} />
          <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
            ...
            <div className="flex flex-col items-start pb-5 border-b-2 border-gray-200 mb-5">
              <div className="mt-5 font-bold">Color:</div>
              <ProductSpec items={['red', 'green', 'blue']} />
            </div>
            <div className="flex flex-col items-start pb-5 border-b-2 border-gray-200 mb-5">
              <div className="font-bold">Size:</div>
              <ProductSpec items={['s', 'm', 'l']} />
            </div>
            <div className="flex flex-col">
              <span className="title-font font-medium text-2xl text-gray-900">
                $58.00
              </span>
              <div className="flex my-5 mr-auto">
